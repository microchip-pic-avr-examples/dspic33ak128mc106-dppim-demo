...
enum ADC1_CHANNEL
{
    ADC1_Channel9,    /**<Channel Name:Channel_9 connected to ADC1_AN9 */
    ADC1_Channel11,    /**<Channel Name:Channel_11 connected to ADC1_AN11 */
    ADC1_MAX_CHANNELS = 2    /**< Maximum number of channels configured by user for ADC1 */
};
...
inline static void ADC1_ChannelSoftwareTriggerEnable(const enum ADC1_CHANNEL channel)
{
    ...
    {
        case ADC1_Channel9:
                AD1SWTRGbits.CH9TRG = 0x1U;
                break;
        case ADC1_Channel11:
                AD1SWTRGbits.CH11TRG = 0x1U;
                break;
        default:
                break;
    }
...
inline static void ADC1_ChannelSoftwareTriggerDisable(const enum ADC1_CHANNEL channel)
{
    ...
    {
        case ADC1_Channel9:
                AD1SWTRGbits.CH9TRG = 0x0U;
                break;
        case ADC1_Channel11:
                AD1SWTRGbits.CH11TRG = 0x0U;
                break;
        default:
                break;
    }
...
inline static uint16_t ADC1_SampleCountGet(const enum ADC1_CHANNEL channel)
{
    ...
    {
        case ADC1_Channel9:
                count = AD1CH9CNTbits.CNT;
                break;
        case ADC1_Channel11:
                count = AD1CH11CNTbits.CNT;
                break;
        default:
                break;
    }
...
inline static uint16_t ADC1_SampleCountStatusGet(const enum ADC1_CHANNEL channel)
{
    ...
    {
        case ADC1_Channel9:
                countStatus = AD1CH9CNTbits.CNTSTAT;
                break;
        case ADC1_Channel11:
                countStatus = AD1CH11CNTbits.CNTSTAT;
                break;
        default:
                break;
    }
...
inline static bool ADC1_IsConversionComplete(const enum ADC1_CHANNEL channel)
{
    ...
    {
        case ADC1_Channel9:
                status = AD1STATbits.CH9RDY;
                break;
        case ADC1_Channel11:
                status = AD1STATbits.CH11RDY;
                break;
        default:
                break;
    }
...
inline static void ADC1_IndividualChannelInterruptPrioritySet(const enum ADC1_CHANNEL channel, enum INTERRUPT_PRIORITY priorityValue)
{
	...
	{
		case ADC1_Channel9:
				IPC20bits.AD1CH9IP = priorityValue;
				break;
		case ADC1_Channel11:
				IPC21bits.AD1CH11IP = priorityValue;
				break;
		default:
				break;
	}
